...
namespace WpfServiceTask.Test.Classes
{
	public class ClientDataTest
	{
		...
		public void TestConstructorWithMultParams(string fName, string lName, string pNumber, Address address)
		{
			var actual = new ClientData(fName, lName,  pNumber, address);
		...
		[Theory]
		[MemberData(nameof(TestData.Data), MemberType = typeof(TestData))]
		public void TestConstructorXmlParam(string fName, string lName, string pNumber, Address address)
		{
			var doc = new XmlDocument();
			var element = CreateXmlElement(doc, fName, lName, pNumber, address);
		...
		public void TestConstructorThrowsNullReferenceExcpetion()
		{
			...
			var element = CreateXmlElement(doc, "FName", "Lname", "+380000000", new Address("city", "street", 10));
		...
		[Theory]
		[MemberData(nameof(TestData.Data), MemberType = typeof(TestData))]
		public void TestToXml(string fName, string lName, string pNumber, Address address)
		{
			var addr = new ClientData(fName, lName, pNumber, address);
		...
		private static XmlElement CreateXmlElement(XmlDocument doc, string fName, string lName, string pNumber, Address address)
		{
		...
		private class TestData
		{
			public static IEnumerable<object[]> Data => new List<object[]>
			{
				new object[]
				{
					"FirstName1", "LastName1", "+380000001", new Address("City1", "Street1", 11) 
				},
				new object[]
				{
					"FirstName2", "LastName2", "+380000002", new Address("City2", "Street2", 12) 
				},
				new object[]
				{
					"FirstName3", "LastName3", "+380000003", new Address("City3", "Street3", 13) 
				},
				new object[]
				{
					"FirstName4", "LastName4", "+380000004", new Address("City4", "Street4", 14) 
				},
				new object[]
				{
					"FirstName5", "LastName5", "+380000005", new Address("City5", "Street5", 15) 
				}
			};
		}
	}
